...
export const SOLANA_KNOWLEDGE_AGENT_PROMPT: string = `
...
/** Frozen export for safe reuse */
export const SOLANA_KNOWLEDGE_PROMPT_CONFIG = Object.freeze({
  prompt: SOLANA_KNOWLEDGE_AGENT_PROMPT,
  tool: SOLANA_GET_KNOWLEDGE_NAME,
})
